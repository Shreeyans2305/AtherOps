...
function Dashboard() {
    ...
    useEffect(() => {
        ...
        wsService.on('new_event', (data) => {
            ...
            if (!data || !data.event) {
                console.warn('Received invalid event data:', data);
                return;
            }
            ...
            try {
                ...
                console.error('Error updating chart with new event:', err);
            }
    ...
    return (
        <div className="app">
            <Sidebar activeView={activeView} onViewChange={setActiveView} user={user} organization={organization} />
                ...
                {activeView === 'dashboard' && (
                    <div className="dashboard-layout">
                            ...
                            <div className="header-content">
                                <div>
                                    ...
                                    <p className="dashboard-subtitle">
                                        {organization ? `${organization.name} - Multi-Agent Healing System` : 'Multi-Agent Healing System'}
                                    </p>
                                </div>
                                <ThemeToggle />
                            </div>
                        ...
                        <div className="content-grid">
                            {/* Left: Log Feed (Replaces Timeline) */}
                            <div className="timeline-panel slide-in-left">
                                <LogFeed logs={recentEvents.slice(0, 100)} />
                            </div>
